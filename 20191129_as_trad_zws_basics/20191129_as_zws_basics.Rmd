...
Als Kontext für den Artikel^[Analoge Ideen können auch für die Einführung in den ZWS-Kurs verwendet werden.] nehmen wir eine Zuchtorganisation an, welche eine Population von Nutztieren in eine bestimmte Richtung nachhaltig verändern möchte. Die Verwendung des Begriffs der Nachhaltigkeit deutet darauf hin, dass die Veränderung nicht aufgrund von temporär gut gewählten äusseren Faktoren zustande kommen soll, sondern dass sich diese Veränderung im Erbgut der Keimbahn der Population verankern soll. Somit manifestiert sich die Ausprägung der veränderten Eigenschaften unabhängig von den verschiedenen Umwelten in welchen die Nutztiere gehalten werden.
...
Sobald wir einfach messbare Merkmale festgelegt haben, dann braucht es genügen Daten für eine erste genetische Analyse. Diese besteht aus einer deskriptiven Statistik der Merkmale und möglicher Einflussfaktoren auf die Merkmale. Eine genauere Bestimmung der Einflussfaktoren auf die Merkmale wird dann in der Modellselektion gemacht. Dort werden die Umwelteinflüsse bestimmt, welche einen Einfluss auf die Merkmale haben. Mit der Varianzanalyse wird dann bestimmt, ob die beobachtete Variation in einem Merkmal auch einen genetischen Anteil aufweist oder nicht. Nur falls die Variation einen genetischen Hintergrund hat, kann ein bestimmtes Merkmal züchterisch verbessert werden.
